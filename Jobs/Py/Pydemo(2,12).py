...
def _main():
    ...
    # setup driver
    driver = PySCFDriver(
        atom="O 0.000 0.000 0.858; C 0.000 0.741 -0.368; C 0.000 -0.741 -0.368; H 0.914 1.277 -0.613; H 0.914 1.277 -0.613; H 0.914 -1.277 -0.613; H 0.914 -1.277 -0.613;",
        basis="6-31g*",
    ...
    active_space = ActiveSpaceTransformer(2, 12)
